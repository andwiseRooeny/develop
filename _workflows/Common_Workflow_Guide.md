...
## 1. 프로젝트 루트 식별 (Step 0: Root Check)

모든 워크플로우의 **0번째 단계**는 반드시 프로젝트 루트(`_develop/_info/Project_Root.md`)를 확인하고 확보하는 것이어야 합니다. 이는 하드코딩된 절대 경로를 피하고, 어떤 환경에서도 유연하게 실행되기 위함입니다.
